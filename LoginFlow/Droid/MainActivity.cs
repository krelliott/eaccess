using Android.App; using Android.Widget; using Android.OS; using Android.Content; using Android.Util; using Android.Views; using Java.Lang.Reflect; using Java.Lang; using System; using Android.Graphics;
