using System; using Android.Content; using Android.Util; using Android.Views; using Android.Widget; using Java.Lang; using Java.Lang.Reflect; using Android.OS; using Android.Graphics;  
